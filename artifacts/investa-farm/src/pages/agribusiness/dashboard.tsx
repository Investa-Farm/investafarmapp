  ...
  return (
    <div className="app-shell pb-20 page-enter">
      ...
      <div className="relative overflow-hidden" style={{ minHeight: 200 }}>
        <div className={`absolute inset-0 ${isInputSupplier ? "bg-gradient-to-br from-orange-700 via-amber-700 to-yellow-600" : "bg-gradient-to-br from-emerald-800 via-green-700 to-teal-600"}`} />
