  ...
  return (
    <>
      <div className="min-h-dvh w-full max-w-[430px] mx-auto flex flex-col"
        ...
        <div className="flex-1 bg-white dark:bg-card rounded-t-3xl px-6 pt-6 pb-10 overflow-y-auto">
            ...
            {!subType ? (
              <motion.div key="pick-type" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -16 }}>
                ...
                <div className="grid grid-cols-2 gap-3 mb-3">
                  ...
                  <button
                    ...
                    className="p-4 rounded-2xl border-2 border-blue-500 bg-blue-50 dark:bg-blue-950/40 text-left active:scale-95 transition-all"
                  >
                    ...
                    <div className="flex flex-wrap gap-1 mt-2">
                      {["Distributors", "Agribiz"].map(tag => (
                        <span key={tag} className="text-[9px] font-semibold px-1.5 py-0.5 rounded-full bg-blue-100 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300">{tag}</span>
                      ))}
                    </div>
                  </button>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    ...
                    className="p-4 rounded-2xl border-2 border-amber-500 bg-amber-50 dark:bg-amber-950/40 text-left active:scale-95 transition-all"
                  >
                    ...
                    <div className="flex flex-wrap gap-1 mt-2">
                      {["Commission", "Proposals"].map(tag => (
                        <span key={tag} className="text-[9px] font-semibold px-1.5 py-0.5 rounded-full bg-amber-100 dark:bg-amber-900/50 text-amber-700 dark:text-amber-300">{tag}</span>
                      ))}
                    </div>
                  </button>
                  ...
                  <button
                    ...
                    className="p-4 rounded-2xl border-2 border-violet-500 bg-violet-50 dark:bg-violet-950/40 text-left active:scale-95 transition-all"
                  >
                    ...
                    <div className="flex flex-wrap gap-1 mt-2">
                      {["Contracts", "Direct Offtake"].map(tag => (
                        <span key={tag} className="text-[9px] font-semibold px-1.5 py-0.5 rounded-full bg-violet-100 dark:bg-violet-900/50 text-violet-700 dark:text-violet-300">{tag}</span>
                      ))}
                    </div>
                  </button>
                </div>
              ...
              <motion.div key="auth-form" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -16 }}>
                ...
                <div className={`flex items-center gap-2 mb-5 px-4 py-2.5 rounded-2xl ${
                  ...
                  subType === "sales_agent" ? "bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800" :
                  subType === "offtaker" ? "bg-violet-50 dark:bg-violet-950/40 border border-violet-200 dark:border-violet-800" :
                  ...
                  <p className={`text-xs font-semibold ${
                    ...
                    subType === "sales_agent" ? "text-amber-700 dark:text-amber-300" :
                    subType === "offtaker" ? "text-violet-700 dark:text-violet-300" :
                ...
                <div className="flex bg-gray-100 dark:bg-gray-800 rounded-2xl p-1 mb-6">
                  {(["signin", "register"] as const).map(t => (
                    <button key={t} onClick={() => { setTab(t); setError(""); }}
                      className={`flex-1 py-2.5 rounded-xl text-sm font-semibold transition-all ${tab === t ? "bg-white dark:bg-gray-700 shadow-sm text-foreground" : "text-muted-foreground"}`}>
