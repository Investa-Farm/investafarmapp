...
export default function WealthDashboard() {
  ...
  const firmName = localStorage.getItem("investa_wealth_firm") || (user as any)?.name || "Your Fund";
  ...
  const handleLogout = () => {
    clearToken();
    localStorage.removeItem("investa_investor_type");
    localStorage.removeItem("investa_wealth_firm");
    localStorage.removeItem("investa_wealth_aum");
    setLocation("/");
  };
