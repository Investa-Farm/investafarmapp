            ...
            <motion.div key="form" initial={{ opacity: 1 }} exit={{ opacity: 0 }} className="space-y-5">
                  ...
                  {mode === "email" && (
                    <>
                      <div className="mt-1 flex items-center justify-center gap-2">
                        <span className="text-primary font-medium text-sm break-all">{displayEmail || "the address you registered with"}</span>
                        <button
              ...
              {mode === "totp" && (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  className="bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-900 rounded-2xl px-4 py-3 flex items-start gap-3"
                >
                  <KeyRound size={15} className="text-blue-500 dark:text-blue-400 flex-shrink-0 mt-0.5" />
                  <div>
                    <p className="text-blue-800 dark:text-blue-300 text-xs font-semibold">Use your Authenticator App</p>
                    <p className="text-blue-600 dark:text-blue-400 text-[11px] mt-0.5">
