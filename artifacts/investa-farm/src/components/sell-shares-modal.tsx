...
import { X, TrendingUp, CheckCircle2, Loader2, Tag, ChevronRight } from "lucide-react";
...
export function SellSharesModal({ open, onClose, holding, seasonStatus = "mid_season" }: SellSharesModalProps) {
  ...
  const resetAndClose = () => {
    onClose();
    setTimeout(() => { setStep("configure"); }, 400);
  };
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-foreground font-bold text-base">
                    {step === "configure" ? "List Shares for Sale" : step === "review" ? "Confirm Listing" : "Listed!"}
                  </p>
