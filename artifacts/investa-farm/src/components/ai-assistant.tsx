...
function getStaticResponse(q: string, role: string): string | null {
  ...
  if (l.includes("wallet") || l.includes("mkoba") || l.includes("pesa") || l.includes("money") || l.includes("mpesa")) {
    return "Your Investa Wallet is your money hub! You can top up via M-Pesa, MTN, Airtel, Visa, or Mastercard — all through PesaPal. Withdrawals go back to your mobile money within 1 to 2 business days. Pesa yako, wakati wako!";
  }
