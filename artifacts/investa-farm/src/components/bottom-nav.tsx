...
import { BarChart2, Briefcase, Activity, User, Home, Handshake, Package, ClipboardList, ShoppingBasket, Bell } from "lucide-react";
            ...
            <Link key={path} href={path}>
              ...
              >
                <div className="relative">
                  <Icon size={role === "farmer" ? 20 : 20} strokeWidth={isActive ? 2.5 : 1.8} />
                  {showBadge && (
